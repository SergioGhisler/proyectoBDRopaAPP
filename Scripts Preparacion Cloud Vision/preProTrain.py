...
Train_directory1 = '/Users/sergioghislergomez/Downloads/train/image'
Train_directory2 = '/Users/sergioghislergomez/Downloads/train/annos'
...
for filename in Train_images:
    nombre=filename[:-4]
    im =Image.open('/Users/sergioghislergomez/Downloads/train/image/'+filename)
    width, height = im.size
    with open('/Users/sergioghislergomez/Downloads/train/annos/'+nombre+'.json') as f:
      data = json.load(f)
    ...
    for i in all_boxes:
        dataset["set"].append("TRAIN")
    
        ruta=str('gs://flying-ropa/image/'+filename)
